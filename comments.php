...
<?php else : ?>
							...
							<p id="comment-notes"><?php _e('Your email is <em>never</em> published nor shared.', 'uthili') ?> <?php if ($req) _e('Required fields are marked <span class="required">*</span>', 'uthili') ?></p>

              <div id="form-section-author" class="form-section">
								<div class="form-label"><label for="author"><?php _e('Name', 'uthili') ?></label> <?php if ($req) _e('<span class="required">*</span>', 'uthili') ?></div>
								<div class="form-input"><input id="author" name="author" type="text" value="<?php echo $comment_author ?>" size="30" maxlength="20" tabindex="3" /></div>
              </div><!-- #form-section-author .form-section -->

              <div id="form-section-email" class="form-section">
								<div class="form-label"><label for="email"><?php _e('Email', 'uthili') ?></label> <?php if ($req) _e('<span class="required">*</span>', 'uthili') ?></div>
